---
title: Install Meowrch from Windows (Complete Guide)
description: Step-by-step Meowrch installation guide from Windows to a ready-to-use Arch setup
sidebar:
  order: 1
---
...
This guide will help you install Meowrch from Windows — from creating a bootable USB drive to installing a ready-to-use Arch Linux setup.

Looking for the technical details behind the automatic installer? See the [Builder documentation](/en/installation/builder/). If you ever need to roll back changes, see [How to uninstall Meowrch](/en/installation/uninstall/).
