...
description: "Technical documentation for Builder — Meowrch’s automatic Arch Linux installer (packages + dotfiles)"
---

Builder is Meowrch’s automatic Arch Linux setup tool written in Python. It runs an interactive survey, installs packages, and applies dotfiles for Hyprland (Wayland) and/or BSPWM (X11) based on your choices.

For end-user step-by-step installation, see the [complete installation guide](/en/installation/complete-guide/).
...
**Note**: For information on how to start the installation, see [Complete Installation Guide](/en/installation/complete-guide).