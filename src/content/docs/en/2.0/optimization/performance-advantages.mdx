...
description: Detailed description of system optimizations and performance
  advantages of the Meowrch distribution
slug: en/2.0/optimization/performance-advantages
---
