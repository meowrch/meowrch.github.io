...
description: "Техническая документация Builder — автоматического установщика Meowrch для Arch Linux (пакеты + dotfiles)"
---

Builder — это автоматический установщик и конфигуратор Meowrch для Arch Linux, написанный на Python. Он проводит интерактивный опрос, устанавливает пакеты и применяет dotfiles для Hyprland (Wayland) и/или BSPWM (X11) в зависимости от выбранных параметров.

Если вам нужен пользовательский пошаговый гайд установки — см. [полное руководство](/ru/installation/complete-guide/).
